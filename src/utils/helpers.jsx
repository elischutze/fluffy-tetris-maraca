...
import { getCookie, USER_AUTH_COOKIE } from './storageUtils';

// Fetch Helpers
export const API_URL = 'https://guarded-thicket-22918.herokuapp.com';
export const authHeader = { Authorization: getCookie(USER_AUTH_COOKIE) || '' };
export const getJSON = res => res.json();
export const logError = err => console.error('Uh oh! ', err);
